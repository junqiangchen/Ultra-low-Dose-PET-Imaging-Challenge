...
if __name__ == '__main__':
    # save_file2csv(r'D:\challenge\data\DRAC2022\process\A\1\augtrain', 'data/taskA1trainaug.csv')
    # save_file2csv(r'D:\challenge\data\DRAC2022\process\A\2\augtrain', 'data/taskA2trainaug.csv')
    # save_file2csv(r'D:\challenge\data\DRAC2022\process\A\3\augtrain', 'data/taskA3trainaug.csv')
    save_file2csv(r'E:\challenge\data\2022Ultra-low dose PET\task_dose1_2\train', 'data/traindose1_2.csv')
    save_file2csv(r'E:\challenge\data\2022Ultra-low dose PET\task_dose1_2\validation', 'data/validatadose1_2.csv')
    # save_file2csv(r'D:\challenge\data\Instance2022\trainstage\augtrain', 'data/trainaugdata.csv')
    # save_file2csvclassify(r"D:\challenge\data\2022Lung Nodule Analysis\NoduleTypebinary\augtrain",
    #                       'data/augtrainTypebinary.csv')
    # save_file2csvclassify(r"D:\challenge\data\2022Lung Nodule Analysis\NoduleType\augtrain", 'data/augtrainType.csv')